    ...
    <div class="container mx-auto px-6 flex flex-wrap items-center justify-between ">
      ...
      <div v-if="store.isInitialized" class="flex md:order-2">
        ...
        <button  data-collapse-toggle="navbar-sticky" type="button"
          class="hidden inline-flex items-center p-2 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
